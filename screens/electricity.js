        ...
        <View style={{ alignItems: "stretch" }}>
          ...
          <View style={{ marginTop: 40 }}>
            ...
            <Dropdown
              ...
              data={[
                { label: "Select Electricity Provider", value: "" },
          ...
          <View style={{ marginTop: 20 }}>
            <Text style={{ fontSize: 14, color: "#162844" }}>Meter Number</Text>
            <TextInput
          ...
          <View style={{ marginTop: 20 }}>
            <Text style={{ fontSize: 14, color: "#162844" }}>Meter Type</Text>
            <Dropdown
              style={{
                marginTop: 10,
                borderColor: "#E0E0E0",
              ...
              data={[
                ...
                { label: "Pre-paid", value: "Date" },
                { label: "Pre-paid", value: "type" },
              ]}
              maxHeight={500}
              labelField="label"
              valueField="value"
